  ...
  <footer className="bg-sidebar text-sidebar-foreground mt-auto">
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <div className="flex items-center gap-2 font-bold text-lg mb-3">
            ...
            SIG Fotokopi Dramaga
          </div>
          <p className="text-sidebar-foreground/70 text-sm leading-relaxed">
            Sistem Informasi Geografis untuk menemukan jasa fotokopi terdekat di wilayah Dramaga, Bogor.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2 text-sidebar-foreground/70">
              <Mail className="h-4 w-4" /> info@sigfotokopi.id
            </li>
            <li className="flex items-center gap-2 text-sidebar-foreground/70">
      ...
      <div className="border-t border-sidebar-border mt-8 pt-6 text-center text-sm text-sidebar-foreground/50">
        © 2026 SIG Fotokopi Dramaga. All rights reserved.
      </div>
    </div>
  </footer>
);
